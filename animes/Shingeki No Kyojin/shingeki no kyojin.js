...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/attack on titan img 40.png"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/attack on titan img 43.png"
		...
		imagen1.src = "../../imagenes/attack on titan img 55.png"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/atack on titan img 11.webp"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar1_1 = document.querySelector(".boton-descargar-1-1")
const botonDescargarOvas = document.querySelector(".boton-descargar-ovas")
...
const botonDescargar3_3 = document.querySelector(".boton-descargar-3-3")
...
const botonDescargar4_4 = document.querySelector(".boton-descargar-4-4")
const botonDescargar4_5 = document.querySelector(".boton-descargar-4-5")

botonDescargar1.addEventListener("click", descargar1)
botonDescargar1_1.addEventListener("click", descargar1_1)
botonDescargarOvas.addEventListener("click", descargarOvas)
...
botonDescargar3_3.addEventListener("click", descargar3_3)
...
botonDescargar4_4.addEventListener("click", descargar4_4)
botonDescargar4_5.addEventListener("click", descargar4_5)



let enlaceMediafire = document.querySelector(".link-1")
let enlaceovas = document.querySelector(".link-ovas")
let enlacetemp4 = document.querySelector(".link-temp-4")
let enlacetemp41 = document.querySelector(".link-temp-4-1")
let mediafire1 = `https://www.mediafire.com/folder/8o9zaw268arjy/SNK+T1`
let mediafire1_1 = `https://www.mediafire.com/folder/7wyyt3icdxn3k/SNKT1`
let mediafireOvas = `shingeki no kyojin ovas.html`
let mediafire2 = `https://www.mediafire.com/folder/9qg7aun5se4rl/SNK+T2`
let mediafire2_2 = `https://www.mediafire.com/folder/3v43nu8ymg0x4/Camera`
let mediafire3 = `https://www.mediafire.com/folder/bqy15i0avi25k/Ataque+a+Los+Titanes+T3+Parte1`
let mediafire3_3 = `https://www.mediafire.com/folder/jk8ptzmp7q67i/SNKT3P1`
let mediafire3_2 = `https://www.mediafire.com/folder/2mb90e3hj8n6m/SNKT3P2`
let mediafire4 = `shingeki no kyojin 4-1.html`
let mediafire4_2 = `shingeki no kyojin 4.html`
let mediafire4_4 = `https://www.mediafire.com/file/tz1aa7fud0l9qt8/%2528locuranime.com%2529720p_SnK-TheFS-KH.rar/file`
let mediafire4_5 = `https://www.mediafire.com/file/39jmlzzt59q5cxt/%2528locuranime.com%2529720p_SnK-TheFS-KH-P2.rar/file`
...
function descargar1_1(){
	enlaceMediafire.setAttribute("href", mediafire1_1)
	enlaceMediafire.click()
}

function descargarOvas(){
	enlaceovas.setAttribute("href", mediafireOvas)
	enlaceovas.click()
}
function descargar2(){
...
function descargar3_3(){
	enlaceMediafire.setAttribute("href", mediafire3_3)
	enlaceMediafire.click()
}
...
function descargar4(){
	enlacetemp41.setAttribute("href", mediafire4)
	enlacetemp41.click()
}
function descargar4_2(){
	enlacetemp4.setAttribute("href", mediafire4_2)
	enlacetemp4.click()
}
function descargar4_4(){
	enlaceMediafire.setAttribute("href", mediafire4_4)
	enlaceMediafire.click()
}
function descargar4_5(){
	enlaceMediafire.setAttribute("href", mediafire4_5)
	enlaceMediafire.click()
}
