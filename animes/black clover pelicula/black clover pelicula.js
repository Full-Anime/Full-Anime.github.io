...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/black clover img 4.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/black clover pelicula img 2.jpg"
		...
		imagen1.src = "../../imagenes/black clover img 31.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/balck clover pelicula img 1~2.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/folder/iwgqqs08u67yl/Black+Clover.+La+Espada+del+Rey+Mago+-+Espa%C3%83%C2%B1ol+Latino`
