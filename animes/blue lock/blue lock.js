...
function avanzar(){
	...
	if (adelanteA == true) {
		...
		imagen2.src = "../../imagenes/blue lock img 9.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://app.mediafire.com/vsirkpsu78lna`
let mediafire1Lat = `blue lock 1.html`
let mediafire1_2 = `https://app.mediafire.com/0czwz7lsusbdv`
