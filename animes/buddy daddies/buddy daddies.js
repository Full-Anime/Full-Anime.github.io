...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/buddy daddies img 4.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/buddy daddies img 2.jpg"
		...
		imagen1.src = "../../imagenes/buddy daddies imm 10.png"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/buddy daddies img 1.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/folder/6ujlia0rz6lvw`
