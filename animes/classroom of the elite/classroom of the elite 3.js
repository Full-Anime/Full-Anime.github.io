...
function avanzar(){
	...
	if (adelanteA == true) {
		...
		imagen2.src = "../../imagenes/clssroom of the elite img 9.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/tm6risioc2cbrf2/Classroom_of_the_Elite_S3_Latino_episodio_1_[mandranime].zip/file`
let mediafire2 = `https://www.mediafire.com/file/fw17spior109e0a/Classroom_of_the_Elite_S3_Latino_episodio_2_[mandranime].zip/file`
...
let mediafire2_1 = `https://www.mediafire.com/file/0ygrmv1bj42cxnf/Youkoso_Jitsuryoku_Shijou_Shugi_no_Kyoushitsu_e_3rd_Season_episodio_2_[mandranime].zip/file`
let mediafire3_1 = `https://www.mediafire.com/file/31e8zu6zhivl69j/Youkoso_Jitsuryoku_Shijou_Shugi_no_Kyoushitsu_e_3rd_Season_episodio_3_[mandranime].zip/file`
let mediafire4_1 = `https://www.mediafire.com/file/um4mf1bg0jadn05/Youkoso_Jitsuryoku_Shijou_Shugi_no_Kyoushitsu_e_3rd_Season_episodio_4_[mandranime].zip/file`
let mediafire5_1 = `https://www.mediafire.com/file/sv0y2yln5m766zs/Youkoso_Jitsuryoku_Shijou_Shugi_no_Kyoushitsu_e_3rd_Season_episodio_5_[mandranime].zip/file`
...
document.querySelector(".boton-descargar-5-1").addEventListener("click", ()=>{
	enlaceMediafire.setAttribute("href", mediafire5_1)
	enlaceMediafire.click()
})
document.querySelector(".boton-descargar-6-1").addEventListener("click", ()=>{
	enlaceMediafire.setAttribute("href", mediafire6_1)
	enlaceMediafire.click()
})
document.querySelector(".boton-descargar-7-1").addEventListener("click", ()=>{
	enlaceMediafire.setAttribute("href", mediafire7_1)
	enlaceMediafire.click()
})
