...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/kimetsu no yaiba img 2.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/demon slayer pelicula img 9.jpg"
		...
		imagen1.src = "../../imagenes/demon slayer pelicula img 1.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/demon slayer pelicula img 2~2.jpg"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar1 = document.querySelector(".boton-descargar-movie")
const botonDescargar2 = document.querySelector(".boton-descargar-movie-1080p")
...
let mediafireMovie = `https://www.mediafire.com/file/2pv8o66j1rb4zhi/MUG3N_720.exe/fileCopiar%20enlaceEnlace%20copiado`
let mediafireMovie1080p = `https://www.mediafire.com/file/tjvqut90qxycq52/MUG3N_1080.exe/file`
...
function descargar2(){
	enlaceMediafire.setAttribute("href", mediafireMovie1080p)
	enlaceMediafire.click()
}
