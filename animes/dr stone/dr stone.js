...
const botonDescargar1Drive = document.querySelector(".boton-descargar-1-drive")
...
const botonDescargar3_2_ligero = document.querySelector(".boton-descargar-3-2_2")


botonDescargar1.addEventListener("click", descargar1)
botonDescargar1Drive.addEventListener("click", descargar1Drive)
...
botonDescargar3_2_ligero.addEventListener("click", descargar3_2_ligero)



let enlaceMediafire = document.querySelector(".link-1")
let mediafire1 = `https://www.mediafire.com/folder/9jn5lnf7xdavq`
let mediafire1Drive = `https://drive.google.com/drive/folders/108Hlf8cEaQCb1sEtJjDo50f2sxdNuo1q`
...
let mediafire3_2 = `https://www.mediafire.com/folder/vv0p704p8lns9`
let mediafire3_2_ligero = `https://drive.google.com/drive/folders/1YUz8KdJYduidSiZi80wfUrz7MQU94nYA`
...
function descargar1Drive(){
	enlaceMediafire.setAttribute("href", mediafire1Drive)
	enlaceMediafire.click()
}
...
function descargar3_2_ligero(){
	enlaceMediafire.setAttribute("href", mediafire3_2_ligero)
	enlaceMediafire.click()
}
