...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/dragon ball super broly img 9.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/dragon ball suepr broly img 8.jpg"
		...
		imagen1.src = "../../imagenes/dragon ball super super hero img 3.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/dragon ball super super hero img 1~2.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/q9jlvlvxywxscy3/SUPERH3R0.rar/file`
