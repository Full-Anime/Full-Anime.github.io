...
let adelanteD = false
		...
		if (adelanteA == true) {
	imagen1.src = "../../imagenes/dragon ball super img 2.webp"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/dragon ball super img 6.jpg"
		...
		imagen1.src = "../../imagenes/dragon ball z img 3.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/dragon ball  super img 14.jpg"
		contenedorImg.appendChild(imagen2)
