...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/dragon ball z img 12.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/dragon ball z img 14.jpg"
		...
		imagen1.src = "../../imagenes/dragon ball z img 13.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/dragon  ball z img 15.webp"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar3_1 = document.querySelector(".boton-descargar-3-1")
...
botonDescargar3_1.addEventListener("click", descargar3_1)
botonDescargar4.addEventListener("click", descargar4)


let enlaceMediafire = document.querySelector(".link-1")
let mediafire1 = `https://drive.google.com/drive/folders/1WzFf7hWqkReI6CPcuzgKUpM23byNFWuW`
let mediafire1_2 = `https://www.mediafire.com/file/4eobdekbg37kf21/17-_La_Batalla_Del_Padre_De_Gok%25C3%25BA-17.rar/file`
let mediafire2 = `https://drive.google.com/drive/folders/1kXmG_h04xux78eABxhIu1GEdjDLMeHqv`
let mediafire3 = `https://drive.google.com/drive/folders/11d1Vlfdb-WI5KPsShM77OL_bkvaXOJ1O`
let mediafire3_1 = `https://www.mediafire.com/file/1ipcz3qv4eew2gz/18-Gohan_Y_Trunks_Un_Futuro_Diferente-18.rar/file`
let mediafire4 = `https://drive.google.com/drive/folders/1UzmvZEFHQNkvKnNOSHXv_qcome-BYUQH`
