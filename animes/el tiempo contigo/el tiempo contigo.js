...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/el tiempo contigo img 1.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/el tiempo contigo img 4~2.jpg"
		...
		imagen1.src = "../../imagenes/el tiempo contigo img 8.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/el tiemo contigo img 8.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/qnbeodcqi1ogvdp/Tenki_no_Ko_Pel%C3%ADcula_Latino__[_Descargaranimes.net].rar/file`
