...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/evangelion img 10.webp"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/evangeluion img 3.webp"
		...
		imagen1.src = "../../imagenes/evangelion 36.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/evangelion img 34~2.jpg"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar1_5 = document.querySelector(".boton-descargar-1-5")
...
botonDescargar1_5.addEventListener("click", descargar1_5)



let enlaceMediafire = document.querySelector(".link-1")
let mediafire1 = `https://www.mediafire.com/file/hwl9bu7z7iajsaz/%2528locuranime.com%2529_NoGeEv-01-06.rar/file`
let mediafire1_2 = `https://www.mediafire.com/file/uishihyar0tsal3/%2528locuranime.com%2529_NoGeEv-07-12.rar/file`
let mediafire1_3 = `https://www.mediafire.com/file/0442t2qa4bep1oy/%2528locuranime.com%2529_NoGeEv-13-18.rar/file`
let mediafire1_4 = `https://www.mediafire.com/file/c8v0dg86zcrqik0/%28locuranime.com%29_NoGeEv-19-24.rar/file`
let mediafire1_5 = `https://www.mediafire.com/file/n34opt9i9grp6dz/%2528locuranime.com%2529_NoGeEv-25-26.rar/file`
...
function descargar1_3(){
	enlaceMediafire.setAttribute("href", mediafire1_3)
	enlaceMediafire.click()
}
function descargar1_4(){
	enlaceMediafire.setAttribute("href", mediafire1_4)
	enlaceMediafire.click()
}
function descargar1_5(){
	enlaceMediafire.setAttribute("href", mediafire1_5)
	enlaceMediafire.click()
}
