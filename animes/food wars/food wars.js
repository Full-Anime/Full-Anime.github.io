...
let adelanteD = false
if (adelanteA == true) {
	imagen1.src = "../../imagenes/food wars img 5~3.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/food wars img 1~2.jpg"
		...
		imagen1.src = "../../imagenes/food wars img 4.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/food wars img 17.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/5mtn9icceajl87l/Shokugeki+no+Souma+tem+1.rar/file`
let mediafire2 = `https://mega.nz/folder/s0hygTDR#nRLmRGWFFTOlb0mYlfug0w`
let mediafire1Lat = `food wars 1.html`
let mediafire2Lat = `https://www.mediafire.com/file/8ltqd51vnsn7p1j/%28locuranime.com%29_SnoS2.rar/file`
