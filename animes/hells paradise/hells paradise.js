...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/hells paradize img 5.jpeg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/hells paradize img 3.jpg"
		...
		imagen1.src = "../../imagenes/hells paradise img 10.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/hells paradise img 9.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/folder/qv0z70zlh522a/LAT`
let mediafire1_1080 = `https://www.mediafire.com/folder/n4hhow5v0lpl2/Para%C3%ADso_del_infierno_DUAL_FHD`
