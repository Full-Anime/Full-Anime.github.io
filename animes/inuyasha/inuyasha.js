...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/inuyasha img 2.webp"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/inuyasha img 5.jpg"
		...
		imagen1.src = "../../imagenes/inuyasha img 3.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/inuyasha img 1~2.png"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar2_2 = document.querySelector(".boton-descargar-2_2")
...
let mediafire1 = `https://www.mediafire.com/file/xk12kzdzwkbudte/Inuyasha_%2528Latino%2529.rar/file`
let mediafire2 = `https://www.mediafire.com/file/n48yivv52lgar03/InuYasha_Kanketsu-Hen_The_Final_Act_%2528Latino%2529.rar/file`
let mediafire2_2 = `https://www.mediafire.com/file/1el8cau26gi7edu/Inuyasha_Kanketsu_Hen_%2528Sub_Espa%25C3%25B1ol%2529.rar/file`
