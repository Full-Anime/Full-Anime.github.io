...
const botonDescargarMovie1080p = document.querySelector(".boton-descargar-movie-1080p")
...
botonDescargarMovie1080p.addEventListener("click", descargarMovie1080p)

enlaceMediafire = document.querySelector(".link-1")
enlaceMediafire3 = document.querySelector(".link-1-3")
let mediafire1 = `https://drive.google.com/drive/folders/1kzp-J3fqVrefxZAdDKIH3mlbrq1NeiPO`
