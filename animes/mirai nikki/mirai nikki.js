...
let adelanteD = false
if (adelanteA == true) {
	imagen1.src = "../../imagenes/mirai nikki img 4.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/mirai nikki img 9.jpg"
		...
		imagen1.src = "../../imagenes/mirai nikki img 2.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/mirai-nikki.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/folder/o88bkrng8jn31/Mirai+Nikki+Espa%C3%B1ol+Latino`
let mediafire2 = `https://www.mediafire.com/folder/kdocamag34ydy/Mirai+Nikki+Espa%C3%B1ol+Latino`
