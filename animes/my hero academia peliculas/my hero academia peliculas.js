...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/my hero academia dos heroes img 1.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/my hero academia pelicula img 5~2.jpg"
		...
		imagen1.src = "../../imagenes/my hero academia pelicula img4~2.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/my hero academia peliculas img 2.png"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/e8kzrn0ik3qq3zj/My.Hero.Academia.Two.Heroes.%25282018%2529.HD.1080p.Latino.%2528Locura_Anime%2529.mkv/file`
let mediafire2 = ``
let mediafire3 = `https://www.fireload.com/85e1f13dca2a2d30/(locuranime.com)720pMHAWHM_(CamRip).rar`
