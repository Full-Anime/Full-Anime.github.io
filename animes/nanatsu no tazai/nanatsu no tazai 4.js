...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/nanatsu no tazai 4 img 2.png"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/nanatsu no tazai 4 img 4.jpg"
		...
		imagen1.src = "../../imagenes/nanatsu no tazai 4 img 9.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/nanatsu no tazai 5 img 8.png"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/ixubl97iquag88k/7PCCT4_by_BlizzBoyGames.part1.rar`
let mediafire2 = `https://www.mediafire.com/file/k8rs27ursfkt4l8/7PCCT4_by_BlizzBoyGames.part2.rar`
let mediafire3 = `https://www.mediafire.com/file/mra0dq7ngnnkkhn/7PCCT4_by_BlizzBoyGames.part3.rar`
