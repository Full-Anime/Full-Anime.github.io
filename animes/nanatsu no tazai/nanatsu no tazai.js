...
let mediafire3Movie = `../nanatsu no tazai peliculas/nanatsu no tazai peliculas.html`
let mediafire4 = `nanatsu no tazai 4.html`
let mediafire5 = `nanatsu no tazai 5.html`
let mediafire5Movie = `../nanatsu no tazai peliculas/nanatsu no tazai peliculas.html`
...
function descargar3Movie(){
	enlacetemp.setAttribute("href", mediafire3Movie)
	enlacetemp.click()
}
function descargar4(){
...
function descargar5Movie(){
	enlacetemp.setAttribute("href", mediafire5Movie)
	enlacetemp.click()
}
