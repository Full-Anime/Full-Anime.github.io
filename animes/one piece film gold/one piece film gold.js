...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/one piece film gold img 4.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/one piece film gold img 12.jpg"
		...
		imagen1.src = "../../imagenes/one piece film gold img 5.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/one piece film gold img 8.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/z5hprfm30uav3lh/www.animepelishd.wordpress.com-Film.Gold.rar/file`
