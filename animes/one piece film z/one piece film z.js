...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/one piece film z img 9~2.png"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/one piece film z.jpg"
		...
		imagen1.src = "../../imagenes/one piece film z img 9.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/one piece film z img 2~2.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/lsq9601hp00e4eu/www.animepelis.wordpress.com-OnP_F-ZZ.rar/file`
