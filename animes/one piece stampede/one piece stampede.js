...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/one piece film STAMPEDE img 2~2.jpeg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/one piece stampede img 6.jpg"
		...
		imagen1.src = "../../imagenes/one piece stanmpede img 4.png"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/one piece stampede img 5.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/mevcrff0kvdovrm/animepelis.net_0ne-pi-stamp3d3.rar/file`
