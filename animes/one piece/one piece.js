...
const botonDescargarTodo720p = document.querySelector(".boton-descargar-todo-720p")
...
// const botonDescargar12 = document.querySelector(".boton-descargar-12")


botonDescargar1.addEventListener("click", descargar1)
botonDescargarTodo720p.addEventListener("click", descargarTodo720p)
...
// botonDescargar8.addEventListener("click", descargarTodo)
// botonDescargar9.addEventListener("click", descargarTodo)
...
let mediafire1 = `https://www.mediafire.com/folder/ydk16z5aglu0e/One_Piece_Espa%C3%83%C2%B1ol_Latino_Cap_1-40`
let mediafire2 = `https://www.mediafire.com/folder/r56qcqyzcv41o/One_Piece_Espa%C3%83%C2%B1ol_Latino_Cap_41-80`
let mediafire3 = `https://www.mediafire.com/folder/d75ah9pwgenpp/One_Piece_Espa%C3%83%C2%B1ol_Latino_Cap_81-125`
let mediafire4 = `https://www.mediafire.com/folder/q9mtp0zhzu6pa/One_Piece_Espa%C3%83%C2%B1ol_Latino_Cap_126-185`
let mediafire5 = `https://www.mediafire.com/folder/ngr6bmyw774hl/One_Piece_Espa%C3%83%C2%B1ol_Latino_Cap_186-246`
let mediafire6 = `https://www.mediafire.com/folder/abgerd8771v5k/One+Piece+Espa%C3%83%C2%B1ol+Latino+Cap+247-300`
let mediafire7 = `https://www.mediafire.com/folder/puoyzaurmviry/One+Piece+Espa%C3%83%C2%B1ol+Latino+Cap+301-325`
// let mediafire1Al700_sub_480p = `https://drive.google.com/drive/folders/1DWzsZgYa8eyD-kBrcDJm6QYCzVBscIB4`
let mediafireTodo720p = `one piece 1.html`
...
// 	enlaceMediafire.setAttribute("href", mediafire1Al700_sub_480p)
// 	enlaceMediafire.click()
// }
function descargarTodo720p(){
	enlacetemp.setAttribute("href", mediafireTodo720p)
	enlacetemp.click()
}
