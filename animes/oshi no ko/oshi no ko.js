...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/oshi no ko img 4.jpeg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/oshi no ko img 1.jpg"
		...
		imagen1.src = "../../imagenes/oshi no ko img 8.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/oshi no ko img 10.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/folder/nv9kgjk0dofbd`
