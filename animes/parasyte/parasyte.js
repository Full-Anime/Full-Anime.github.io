...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/Parasito-anime-5.png"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/parasyte img 13.jpg"
		...
		imagen1.src = "../../imagenes/parasyte img 7.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/parasyte img 2.png"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/folder/w354wtw2c5vmv/(locuranime.com)+Pasy-01-12`
let mediafire2 = `https://www.mediafire.com/folder/tiadc2sba4ac5/(locuranime.com)+Pasy-13-24`
