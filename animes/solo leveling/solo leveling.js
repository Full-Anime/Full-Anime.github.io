...
let mediafire11caido = `https://drive.google.com/drive/folders/1A7YN1GcyrN0PyzBlKrunUOades1Gi8V6`
...
let mediafire1 = 'https://www.mediafire.com/file/qcxax5al1qlkww9/1solole[mandranime].zip/file'
let mediafire2 = 'https://www.mediafire.com/file/p4m2p9xyxj88vwo/Ore_dake_Level_Up_na_Ken_episodio_2_[mandranime].zip/file'
let mediafire3 = 'https://www.mediafire.com/file/v4bvwveq1zdjkz4/Ore_dake_Level_Up_na_Ken_episodio_3_[mandranime].zip/file'
let mediafire4 = 'https://www.mediafire.com/file/o30e872ytsivufm/Ore_dake_Level_Up_na_Ken_episodio_4_[mandranime].zip/file'
let mediafire5 = 'https://www.mediafire.com/file/mtzxk6pnz8yp673/Ore_dake_Level_Up_na_Ken_5_[mandranime].zip/file'
let mediafire6 = 'https://www.mediafire.com/file/yhboz0lr1bjyr0l/Ore_dake_Level_Up_na_Ken_(Solo_Leveling)_6_Sub_Espa%C3%B1o_[mandranime].zip/file'
let mediafire7 = 'https://www.mediafire.com/file/kteqrd8fskuqfxt/Ore_dake_Level_Up_na_Ken_(Solo_Leveling)_7_Sub_Espa%C3%B1ol_-_[mandranime].zip/file'
...
document.querySelector(".boton-descargar-1-lat").addEventListener("click", () =>{
	enlaceMediafire.setAttribute("href", mediafire1Lat)
	enlaceMediafire.click()
})
...
document.querySelector(".boton-descargar-4-lat").addEventListener("click", () =>{
	enlaceMediafire.setAttribute("href", mediafire4Lat)
	enlaceMediafire.click()
})
...
document.querySelector(".boton-descargar-5-lat").addEventListener("click", () =>{
	enlaceMediafire.setAttribute("href", mediafire5Lat)
	enlaceMediafire.click()
})
