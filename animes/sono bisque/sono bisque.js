...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/sono bisque img 30 .png"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/sono bisque 11.jpg"
		...
		imagen1.src = "../../imagenes/sono bisque img 40.png"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/sono bisque img 38.png"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar1_ligero = document.querySelector(".boton-descargar-1-ligero")
const botonDescargar_1080 = document.querySelector(".boton-descargar-1_2")

botonDescargar1.addEventListener("click", descargar1)
botonDescargar1_ligero.addEventListener("click", descargar1_Ligero)
botonDescargar_1080.addEventListener("click", descargar_1080)

let enlaceMediafire = document.querySelector(".link-1")
let mediafire1 = `https://www.mediafire.com/folder/u8688f83ave1h`
let mediafire1_Ligero = `https://www.mediafire.com/folder/sb1incryaeckk`
let mediafire1_1080 = `https://www.mediafire.com/folder/0m5y5pnqitwtj`

function descargar1(){
	enlaceMediafire.setAttribute("href", mediafire1)
	enlaceMediafire.click()
}
function descargar1_Ligero(){
	enlaceMediafire.setAttribute("href", mediafire1_Ligero)
	enlaceMediafire.click()
}
function descargar_1080(){
