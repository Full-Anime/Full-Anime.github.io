...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/the end of evangelion img 8~2.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/the end of evangelion img 2.png"
		...
		imagen1.src = "../../imagenes/evangelion img 28~2.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/the end of evangelion img 9.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://drive.google.com/drive/folders/1syjiu6zrr-C2BU8ps5i__a3tx8HgDRJo`
