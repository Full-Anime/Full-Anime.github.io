...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/the first slam duink .jpg"
		...
		imagen1.src = "../../imagenes/thw first slam dunk img 2.jpeg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/the first slam dunk img 7.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/file/x8ix3ghakijbyen/ThFiSlDu.rar/file`
