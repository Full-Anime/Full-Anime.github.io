...
let mediafire1 = `https://www.mediafire.com/folder/8ggiftvq6alak/ToGl+(Locura+Anime)`
let mediafire1Drive = `https://drive.google.com/drive/u/0/mobile/folders/1I6eQP6Xhyco8JZzZxGIvR7c1h14glZcn`
let mediafire2 = `https://www.mediafire.com/folder/4xmy99iokhan8/ToGl2+(Locura+Anime)`
let mediafire3 = `tokyo ghoul re 1.html`
let mediafire3_2 = `tokyo ghoul re 2.html`
...
function descargar3(){
	enlaceMediafireTemp.setAttribute("href", mediafire3)
	enlaceMediafireTemp.click()
}
function descargar3_2(){
	enlaceMediafireTemp.setAttribute("href", mediafire3_2)
	enlaceMediafireTemp.click()
}
