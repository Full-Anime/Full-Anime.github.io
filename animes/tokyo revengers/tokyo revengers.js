...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/tokyo revengers img 3.jpeg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/tokyo revengers img 4.jpg"
		...
		imagen1.src = "../../imagenes/tokyo revengers img 11.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/tokyo revengers img 10.webp"
		contenedorImg.appendChild(imagen2)
...
let mediafire1 = `https://www.mediafire.com/folder/f2rotr6jt4zmh/T0K10`
let mediafire1_1 = `https://wakelet.com/wake/fubmL1NHO3T3B9f6YLvfx`
let mediafire2 = `https://www.mediafire.com/folder/6egywqvsu4xhz/TOKYO+REVENGERS+2+AUDIO+LATINO`
let mediafire2_2 = `https://www.mediafire.com/folder/3pvwvplubx6jj/TOKYO+REVENGERS+2+AUDIO+LATINO`
