...
function next2(){
	hrefSiguiente.setAttribute("href", "accion 2.html")
	hrefSiguiente.click()
...
function ultimos(){
		srcPoster1.setAttribute("src", poster[79])
		srcPoster1.setAttribute("alt", alt[79])
		srcPoster1.setAttribute("title", title[79])
		href1.setAttribute("href", enlace[79])
		href1.textContent = textEnlace[79]
		srcPoster2.setAttribute("src", poster[80])
		srcPoster2.setAttribute("alt", alt[80])
		srcPoster2.setAttribute("title", title[80])
		href2.setAttribute("href", enlace[80])
		href2.textContent = textEnlace[80]
		srcPoster3.setAttribute("src", poster[81])
		srcPoster3.setAttribute("alt", alt[81])
		srcPoster3.setAttribute("title", title[81])
		href3.setAttribute("href", enlace[81])
		href3.textContent = textEnlace[81]
		srcPoster4.setAttribute("src", poster[82])
		srcPoster4.setAttribute("alt", alt[82])
		srcPoster4.setAttribute("title", title[82])
		href4.setAttribute("href", enlace[82])
		href4.textContent = textEnlace[82]
		srcPoster5.setAttribute("src", poster[88])
		srcPoster5.setAttribute("alt", alt[88])
		srcPoster5.setAttribute("title", title[88])
		href5.setAttribute("href", enlace[88])
		href5.textContent = textEnlace[88]
		srcPoster6.setAttribute("src", poster[91])
		srcPoster6.setAttribute("alt", alt[91])
		srcPoster6.setAttribute("title", title[91])
		href6.setAttribute("href", enlace[91])
		href6.textContent = textEnlace[91]
		srcPoster7.setAttribute("src", poster[94])
		srcPoster7.setAttribute("alt", alt[94])
		srcPoster7.setAttribute("title", title[94])
		href7.setAttribute("href", enlace[94])
		href7.textContent = textEnlace[94]
		...
		srcPoster9.setAttribute("src", poster[13])
		srcPoster9.setAttribute("alt", alt[13])
		srcPoster9.setAttribute("title", title[13])
		href9.setAttribute("href", enlace[13])
		href9.textContent = textEnlace[13]
		srcPoster10.setAttribute("src", poster[48])
		srcPoster10.setAttribute("alt", alt[48])
		srcPoster10.setAttribute("title", title[48])
		href10.setAttribute("href", enlace[48])
		href10.textContent = textEnlace[48]
		srcPoster11.setAttribute("src", poster[61])
		srcPoster11.setAttribute("alt", alt[61])
		srcPoster11.setAttribute("title", title[61])
		href11.setAttribute("href", enlace[61])
		href11.textContent = textEnlace[61]
		srcPoster12.setAttribute("src", poster[62])
		srcPoster12.setAttribute("alt", alt[62])
		srcPoster12.setAttribute("title", title[62])
		href12.setAttribute("href", enlace[62])
		href12.textContent = textEnlace[62]
		srcPoster13.setAttribute("src", poster[60])
		srcPoster13.setAttribute("alt", alt[60])
		srcPoster13.setAttribute("title", title[60])
		href13.setAttribute("href", enlace[60])
		href13.textContent = textEnlace[60]
		srcPoster14.setAttribute("src", poster[63])
		srcPoster14.setAttribute("alt", alt[63])
		srcPoster14.setAttribute("title", title[63])
		href14.setAttribute("href", enlace[63])
		href14.textContent = textEnlace[63]
