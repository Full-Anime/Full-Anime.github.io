...
function ultimos(){
		...
		srcPoster2.setAttribute("src", poster[0])
		srcPoster2.setAttribute("alt", alt[0])
		srcPoster2.setAttribute("title", title[0])
		href2.setAttribute("href", enlace[0])
		href2.textContent = textEnlace[0]
		...
		srcPoster4.setAttribute("src", poster[34])
		srcPoster4.setAttribute("alt", alt[34])
		srcPoster4.setAttribute("title", title[34])
		href4.setAttribute("href", enlace[34])
		href4.textContent = textEnlace[34]
		...
		srcPoster6.setAttribute("src", poster[29])
		srcPoster6.setAttribute("alt", alt[29])
		srcPoster6.setAttribute("title", title[29])
		href6.setAttribute("href", enlace[29])
		href6.textContent = textEnlace[29]
		...
		srcPoster8.setAttribute("src", poster[6])
		srcPoster8.setAttribute("alt", alt[6])
		srcPoster8.setAttribute("title", title[6])
		href8.setAttribute("href", enlace[6])
		href8.textContent = textEnlace[6]
		srcPoster9.setAttribute("src", poster[78])
		srcPoster9.setAttribute("alt", alt[78])
		srcPoster9.setAttribute("title", title[78])
		href9.setAttribute("href", enlace[78])
		href9.textContent = textEnlace[78]
		...
		srcPoster11.setAttribute("src", poster[58])
		srcPoster11.setAttribute("alt", alt[58])
		srcPoster11.setAttribute("title", title[58])
		href11.setAttribute("href", enlace[58])
		href11.textContent = textEnlace[58]
		srcPoster12.setAttribute("src", poster[59])
		srcPoster12.setAttribute("alt", alt[59])
		srcPoster12.setAttribute("title", title[59])
		href12.setAttribute("href", enlace[59])
		href12.textContent = textEnlace[59]
		srcPoster13.setAttribute("src", poster[33])
		srcPoster13.setAttribute("alt", alt[33])
		srcPoster13.setAttribute("title", title[33])
		href13.setAttribute("href", enlace[33])
		href13.textContent = textEnlace[33]
		srcPoster14.setAttribute("src", poster[45])
		srcPoster14.setAttribute("alt", alt[45])
		srcPoster14.setAttribute("title", title[45])
		href14.setAttribute("href", enlace[45])
		href14.textContent = textEnlace[45]
		srcPoster15.setAttribute("src", poster[15])
		srcPoster15.setAttribute("alt", alt[15])
		srcPoster15.setAttribute("title", title[15])
		href15.setAttribute("href", enlace[15])
		href15.textContent = textEnlace[15]
}
