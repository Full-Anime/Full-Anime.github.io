...
let parrafo = [`<h3>Chainsaw Man</h3><b>Denji</b> es un joven atrapado en la probreza extrema. que trabaja para saldar la deuda de su padre fallecido con la Yakuza trabajando como cazador de demonios, con la ayuda de <b>Pochita</b>, su fiel compañero canino, hermano del alma y tambien conocido como el demonio motosierra.<br><br><b>Genero:</b> Accion<br><br><b>Estudio:</b> Mappa`,
			...
			`<h3>solo leveling</h3>Relata los esfuerzos de los misteriosos y secretos Caballeros Protestantes Reales, la organizacion <b>"solo leveling"</b> y sus combates contra <b>vampiros, ghouls</b> y otros enemigos sobrenaturales que amenazan el Reino Unido de <b>Gran Bretaña</b>.<br><br><b>Genero:</b> Accion, fantasia oscura<br><br><b>Estudio:</b> Gonzo`, 
...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster1.setAttribute("src", poster[19])
		srcPoster1.setAttribute("alt", alt[19])
		srcPoster1.setAttribute("title", title[19])
		href1.setAttribute("href", enlace[19])
		href1.textContent = textEnlace[19]
		...
		srcPoster6.setAttribute("src", poster[25])
		srcPoster6.setAttribute("alt", alt[25])
		srcPoster6.setAttribute("title", title[25])
		href6.setAttribute("href", enlace[25])
		href6.textContent = textEnlace[25]
		srcPoster7.setAttribute("src", poster[26])
		srcPoster7.setAttribute("alt", alt[26])
		srcPoster7.setAttribute("title", title[26])
		href7.setAttribute("href", enlace[26])
		href7.textContent = textEnlace[26]
		...
		srcPoster12.setAttribute("src", poster[37])
		srcPoster12.setAttribute("alt", alt[37])
		srcPoster12.setAttribute("title", title[37])
		href12.setAttribute("href", enlace[37])
		href12.textContent = textEnlace[37]
