...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		srcPoster1.setAttribute("src", poster[29])
		srcPoster1.setAttribute("alt", alt[29])
		srcPoster1.setAttribute("title", title[29])
		href1.setAttribute("href", enlace[29])
		href1.textContent = textEnlace[29]
		srcPoster2.setAttribute("src", poster[24])
		srcPoster2.setAttribute("alt", alt[24])
		srcPoster2.setAttribute("title", title[24])
		href2.setAttribute("href", enlace[24])
		href2.textContent = textEnlace[24]
		srcPoster3.setAttribute("src", poster[31])
		srcPoster3.setAttribute("alt", alt[31])
		srcPoster3.setAttribute("title", title[31])
		href3.setAttribute("href", enlace[31])
		href3.textContent = textEnlace[31]
		srcPoster4.setAttribute("src", poster[41])
		srcPoster4.setAttribute("alt", alt[41])
		srcPoster4.setAttribute("title", title[41])
		href4.setAttribute("href", enlace[41])
		href4.textContent = textEnlace[41]
		srcPoster5.setAttribute("src", poster[60])
		srcPoster5.setAttribute("alt", alt[60])
		srcPoster5.setAttribute("title", title[60])
		href5.setAttribute("href", enlace[60])
		href5.textContent = textEnlace[60]
		srcPoster6.setAttribute("src", poster[67])
		srcPoster6.setAttribute("alt", alt[67])
		srcPoster6.setAttribute("title", title[67])
		href6.setAttribute("href", enlace[67])
		href6.textContent = textEnlace[67]
		srcPoster7.setAttribute("src", poster[69])
		srcPoster7.setAttribute("alt", alt[69])
		srcPoster7.setAttribute("title", title[69])
		href7.setAttribute("href", enlace[69])
		href7.textContent = textEnlace[69]
		srcPoster8.setAttribute("src", poster[70])
		srcPoster8.setAttribute("alt", alt[70])
		srcPoster8.setAttribute("title", title[70])
		href8.setAttribute("href", enlace[70])
		href8.textContent = textEnlace[70]
		srcPoster9.setAttribute("src", poster[97])
		srcPoster9.setAttribute("alt", alt[97])
		srcPoster9.setAttribute("title", title[97])
		href9.setAttribute("href", enlace[97])
		href9.textContent = textEnlace[97]
		srcPoster10.setAttribute("src", poster[27])
		srcPoster10.setAttribute("alt", alt[27])
		srcPoster10.setAttribute("title", title[27])
		href10.setAttribute("href", enlace[27])
		href10.textContent = textEnlace[27]
		srcPoster11.setAttribute("src", poster[33])
		srcPoster11.setAttribute("alt", alt[33])
		srcPoster11.setAttribute("title", title[33])
		href11.setAttribute("href", enlace[33])
		href11.textContent = textEnlace[33]
		srcPoster12.setAttribute("src", poster[61])
		srcPoster12.setAttribute("alt", alt[61])
		srcPoster12.setAttribute("title", title[61])
		href12.setAttribute("href", enlace[61])
		href12.textContent = textEnlace[61]
		srcPoster13.setAttribute("src", poster[92])
		srcPoster13.setAttribute("alt", alt[92])
		srcPoster13.setAttribute("title", title[92])
		href13.setAttribute("href", enlace[92])
		href13.textContent = textEnlace[92]
		srcPoster14.setAttribute("src", poster[73])
		srcPoster14.setAttribute("alt", alt[73])
		srcPoster14.setAttribute("title", title[73])
		href14.setAttribute("href", enlace[73])
		href14.textContent = textEnlace[73]
		srcPoster15.setAttribute("src", poster[97])
		srcPoster15.setAttribute("alt", alt[97])
		srcPoster15.setAttribute("title", title[97])
		href15.setAttribute("href", enlace[97])
		href15.textContent = textEnlace[97]
