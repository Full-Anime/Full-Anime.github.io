...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster1.setAttribute("src", poster[27])
		srcPoster1.setAttribute("alt", alt[27])
		srcPoster1.setAttribute("title", title[27])
		href1.setAttribute("href", enlace[27])
		href1.textContent = textEnlace[27]
		srcPoster2.setAttribute("src", poster[29])
		srcPoster2.setAttribute("alt", alt[29])
		srcPoster2.setAttribute("title", title[29])
		href2.setAttribute("href", enlace[29])
		href2.textContent = textEnlace[29]
		...
		srcPoster6.setAttribute("src", poster[41])
		srcPoster6.setAttribute("alt", alt[41])
		srcPoster6.setAttribute("title", title[41])
		href6.setAttribute("href", enlace[41])
		href6.textContent = textEnlace[41]
