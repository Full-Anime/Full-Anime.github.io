...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster6.setAttribute("src", poster[44])
		srcPoster6.setAttribute("alt", alt[44])
		srcPoster6.setAttribute("title", title[44])
		href6.setAttribute("href", enlace[44])
		href6.textContent = textEnlace[44]
