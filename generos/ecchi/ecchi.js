...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster4.setAttribute("src", poster[70])
		srcPoster4.setAttribute("alt", alt[70])
		srcPoster4.setAttribute("title", title[70])
		href4.setAttribute("href", enlace[70])
		href4.textContent = textEnlace[70]
		srcPoster5.setAttribute("src", poster[71])
		srcPoster5.setAttribute("alt", alt[71])
		srcPoster5.setAttribute("title", title[71])
		href5.setAttribute("href", enlace[71])
		href5.textContent = textEnlace[71]
