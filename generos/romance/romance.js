...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster1.setAttribute("src", poster[21])
		srcPoster1.setAttribute("alt", alt[21])
		srcPoster1.setAttribute("title", title[21])
		href1.setAttribute("href", enlace[21])
		href1.textContent = textEnlace[21]
		...
		srcPoster3.setAttribute("src", poster[38])
		srcPoster3.setAttribute("alt", alt[38])
		srcPoster3.setAttribute("title", title[38])
		href3.setAttribute("href", enlace[38])
		href3.textContent = textEnlace[38]
