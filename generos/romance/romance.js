...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster1.setAttribute("src", poster[38])
		srcPoster1.setAttribute("alt", alt[38])
		srcPoster1.setAttribute("title", title[38])
		href1.setAttribute("href", enlace[38])
		href1.textContent = textEnlace[38]
		...
		srcPoster3.setAttribute("src", poster[71])
		srcPoster3.setAttribute("alt", alt[71])
		srcPoster3.setAttribute("title", title[71])
		href3.setAttribute("href", enlace[71])
		href3.textContent = textEnlace[71]
		srcPoster4.setAttribute("src", poster[72])
		srcPoster4.setAttribute("alt", alt[72])
		srcPoster4.setAttribute("title", title[72])
		href4.setAttribute("href", enlace[72])
		href4.textContent = textEnlace[72]
		srcPoster5.setAttribute("src", poster[50])
		srcPoster5.setAttribute("alt", alt[50])
		srcPoster5.setAttribute("title", title[50])
		href5.setAttribute("href", enlace[50])
		href5.textContent = textEnlace[50]
		srcPoster6.setAttribute("src", poster[65])
		srcPoster6.setAttribute("alt", alt[65])
		srcPoster6.setAttribute("title", title[65])
		href6.setAttribute("href", enlace[65])
		href6.textContent = textEnlace[65]
		...
		srcPoster8.setAttribute("src", poster[84])
		srcPoster8.setAttribute("alt", alt[84])
		srcPoster8.setAttribute("title", title[84])
		href8.setAttribute("href", enlace[84])
		href8.textContent = textEnlace[84]
		srcPoster9.setAttribute("src", poster[89])
		srcPoster9.setAttribute("alt", alt[89])
		srcPoster9.setAttribute("title", title[89])
		href9.setAttribute("href", enlace[89])
		href9.textContent = textEnlace[89]
