...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster1.setAttribute("src", poster[42])
		srcPoster1.setAttribute("alt", alt[42])
		srcPoster1.setAttribute("title", title[42])
		href1.setAttribute("href", enlace[42])
		href1.textContent = textEnlace[42]
		...
		// srcPoster3.setAttribute("src", poster[14])
		// srcPoster3.setAttribute("alt", alt[14])
		// srcPoster3.setAttribute("title", title[14])
		// href3.setAttribute("href", enlace[14])
		// href3.textContent = textEnlace[14]
