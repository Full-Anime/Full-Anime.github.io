...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster2.setAttribute("src", poster[64])
		srcPoster2.setAttribute("alt", alt[64])
		srcPoster2.setAttribute("title", title[64])
		href2.setAttribute("href", enlace[64])
		href2.textContent = textEnlace[64]
		srcPoster3.setAttribute("src", poster[86])
		srcPoster3.setAttribute("alt", alt[86])
		srcPoster3.setAttribute("title", title[86])
		href3.setAttribute("href", enlace[86])
		href3.textContent = textEnlace[86]
