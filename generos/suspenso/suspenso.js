...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster1.setAttribute("src", poster[1])
		srcPoster1.setAttribute("alt", alt[1])
		srcPoster1.setAttribute("title", title[1])
		href1.setAttribute("href", enlace[1])
		href1.textContent = textEnlace[1]
		srcPoster2.setAttribute("src", poster[8])
		srcPoster2.setAttribute("alt", alt[8])
		srcPoster2.setAttribute("title", title[8])
		href2.setAttribute("href", enlace[8])
		href2.textContent = textEnlace[8]
		...
		srcPoster4.setAttribute("src", poster[67])
		srcPoster4.setAttribute("alt", alt[67])
		srcPoster4.setAttribute("title", title[67])
		href4.setAttribute("href", enlace[67])
		href4.textContent = textEnlace[67]
		srcPoster5.setAttribute("src", poster[66])
		srcPoster5.setAttribute("alt", alt[66])
		srcPoster5.setAttribute("title", title[66])
		href5.setAttribute("href", enlace[66])
		href5.textContent = textEnlace[66]
		srcPoster6.setAttribute("src", poster[43])
		srcPoster6.setAttribute("alt", alt[43])
		srcPoster6.setAttribute("title", title[43])
		href6.setAttribute("href", enlace[43])
		href6.textContent = textEnlace[43]
		srcPoster7.setAttribute("src", poster[32])
		srcPoster7.setAttribute("alt", alt[32])
		srcPoster7.setAttribute("title", title[32])
		href7.setAttribute("href", enlace[32])
		href7.textContent = textEnlace[32]
		srcPoster8.setAttribute("src", poster[73])
		srcPoster8.setAttribute("alt", alt[73])
		srcPoster8.setAttribute("title", title[73])
		href8.setAttribute("href", enlace[73])
		href8.textContent = textEnlace[73]
		srcPoster9.setAttribute("src", poster[40])
		srcPoster9.setAttribute("alt", alt[40])
		srcPoster9.setAttribute("title", title[40])
		href9.setAttribute("href", enlace[40])
		href9.textContent = textEnlace[40]
