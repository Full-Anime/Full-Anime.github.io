...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false) {
		...
		srcPoster4.setAttribute("src", poster[32])
		srcPoster4.setAttribute("alt", alt[32])
		srcPoster4.setAttribute("title", title[32])
		href4.setAttribute("href", enlace[32])
		href4.textContent = textEnlace[32]
		srcPoster5.setAttribute("src", poster[43])
		srcPoster5.setAttribute("alt", alt[43])
		srcPoster5.setAttribute("title", title[43])
		href5.setAttribute("href", enlace[43])
		href5.textContent = textEnlace[43]
		srcPoster6.setAttribute("src", poster[40])
		srcPoster6.setAttribute("alt", alt[40])
		srcPoster6.setAttribute("title", title[40])
		href6.setAttribute("href", enlace[40])
		href6.textContent = textEnlace[40]
