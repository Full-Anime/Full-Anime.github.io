...
function ultimos(){
	if (primeraCarga == true && segundaCarga == false && terceraCarga == false) {
		...
		srcPoster13.setAttribute("src", poster[12])
		srcPoster13.setAttribute("alt", alt[12])
		srcPoster13.setAttribute("title", title[12])
		href13.setAttribute("href", enlace[12])
		href13.textContent = textEnlace[12]
...
function estrenos(){
	contenedorBotones.classList.add("boton-3")
		...
		srcPoster11.setAttribute("src", poster[37])
		srcPoster11.setAttribute("alt", alt[37])
		srcPoster11.setAttribute("title", title[37])
		href11.setAttribute("href", enlace[37])
		href11.textContent = textEnlace[37]
