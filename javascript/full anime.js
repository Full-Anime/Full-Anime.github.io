...
function atrasar(){
	...
	if (adelanteD == true) {
		...
		pieDelTitulo1.innerHTML = "8/10"
		pieDelTituloContainer.appendChild(pieDelTitulo1)
		pieDelTitulo2.innerHTML = "47 cap 2019"
		pieDelTituloContainer.appendChild(pieDelTitulo2)
		pieDelTitulo3.innerHTML = "720p"
		pieDelTituloContainer.appendChild(pieDelTitulo3)
		punto4.classList.replace("punto-4-a", "punto-4-e")
...
const hrefSiguiente = document.querySelector(".href-para-siguiente")
...
function next4(){
	hrefSiguiente.setAttribute("href", "secciones/cuarta/cuarta.html")
	hrefSiguiente.click()
}
...
function ultimos(){
		...
		href15.setAttribute("href", enlace[12])
		href15.textContent = textEnlace[12]
...
function tendencias(){
	hrefSiguiente.setAttribute("href", "secciones/peliculas/peliculas.html")
	hrefSiguiente.click()
