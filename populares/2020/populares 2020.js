...
const botonVer8 = document.querySelector(".boton-ver-8")
const botonVer9 = document.querySelector(".boton-ver-9")
const botonVer10 = document.querySelector(".boton-ver-10")
const botonVer11 = document.querySelector(".boton-ver-11")
const botonVer12 = document.querySelector(".boton-ver-12")
const botonVer13 = document.querySelector(".boton-ver-13")
const botonVer14 = document.querySelector(".boton-ver-14")
const botonVer15 = document.querySelector(".boton-ver-15")
const botonVer16 = document.querySelector(".boton-ver-16")
const botonVer17 = document.querySelector(".boton-ver-17")
...
botonVer8.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[28])
	linkSeries.click()
})
botonVer9.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[3])
	linkSeries.click()
})
botonVer10.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[19])
	linkSeries.click()
})
botonVer11.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[29])
	linkSeries.click()
})
botonVer12.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[22])
	linkSeries.click()
})
botonVer13.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[51])
	linkSeries.click()
})
botonVer14.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[85])
	linkSeries.click()
})
botonVer15.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[82])
	linkSeries.click()
})
botonVer16.addEventListener("click", (e)=>{
	linkSeries.setAttribute("href", enlace[78])
	linkSeries.click()
})
botonVer17.addEventListener("click", (e)=>{
