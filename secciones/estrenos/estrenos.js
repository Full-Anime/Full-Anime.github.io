...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/solo leveling fondo 2.jpeg"
	contenedorImg.appendChild(imagen1)
	tituloItem.innerHTML = "Solo Leveling"
	titulo.appendChild(tituloItem)
	informacionItem.innerHTML = "En un mundo en el que ciertos humanos poseen habilidades magicas, llamados cazadores deben luchar contra monstruos para proteger a la raza humana de una aniquilacion segura, un cazador muy debil  llamado <b>Sung Jinwoo</b> se encuentra en una lucha en la que solo puede tratar de sobrevivir."
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/mashle 2 fondo 1.webp"
		...
		tituloItem.innerHTML = "Mashle Temporada 2"
		titulo.appendChild(tituloItem)
		informacionItem.innerHTML = `La historia de <b>"Mashle"</b> se ambienta en un mundo de fantasia con dragones y todo tipo de criaturas donde cada hijo de vecino tiene habilidades magicas. Tus poderes determinan tu estatus social, y los que no tienen magia lo tienen muy crudo.`
		informacion.appendChild(informacionItem)
		pieDelTitulo1.innerHTML = "9/10"
		pieDelTituloContainer.appendChild(pieDelTitulo1)
		...
		imagen1.src = "../../imagenes/sousou no fierren img 40.jpeg"
		contenedorImg.appendChild(imagen1)
		...
		tituloItem.innerHTML = "Sousou no Fierren"
		titulo.appendChild(tituloItem)
		informacionItem.innerHTML = `La historia sigue a la maga elfa Fierren, una exmienbro del grupo de aventureros que derroto al Rey Demonio restaura la armonia en el mundo despues de una busqueda de diez años.`
		informacion.appendChild(informacionItem)
		pieDelTitulo1.innerHTML = "9/10"
		pieDelTituloContainer.appendChild(pieDelTitulo1)
...
function estrenos(){
	srcPoster1.setAttribute("src", poster[40])
		...
		href11.setAttribute("href", enlace[9])
		href11.textContent = textEnlace[9]
		srcPoster12.setAttribute("src", poster[29])
		srcPoster12.setAttribute("alt", alt[29])
		srcPoster12.setAttribute("title", title[29])
		href12.setAttribute("href", enlace[29])
		href12.textContent = textEnlace[29]
		srcPoster13.setAttribute("src", poster[37])
		srcPoster13.setAttribute("alt", alt[37])
		srcPoster13.setAttribute("title", title[37])
		href13.setAttribute("href", enlace[37])
		href13.textContent = textEnlace[37]
		srcPoster14.setAttribute("src", poster[48])
		srcPoster14.setAttribute("alt", alt[48])
		srcPoster14.setAttribute("title", title[48])
		href14.setAttribute("href", enlace[48])
		href14.textContent = textEnlace[48]
		srcPoster15.setAttribute("src", poster[58])
		srcPoster15.setAttribute("alt", alt[58])
		srcPoster15.setAttribute("title", title[58])
		href15.setAttribute("href", enlace[58])
		href15.textContent = textEnlace[58]
}
