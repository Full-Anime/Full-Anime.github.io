...
function next1(){
	hrefSiguiente.setAttribute("href", "peliculas.html")
	hrefSiguiente.click()
...
function tendencias(){
	srcPoster1.setAttribute("src", poster[54])
		srcPoster1.setAttribute("alt", alt[54])
		srcPoster1.setAttribute("title", title[54])
		href1.setAttribute("href", enlace[54])
		href1.textContent = textEnlace[54]
		srcPoster2.setAttribute("src", poster[90])
		srcPoster2.setAttribute("alt", alt[90])
		srcPoster2.setAttribute("title", title[90])
		href2.setAttribute("href", enlace[90])
		href2.textContent = textEnlace[90]
		srcPoster3.setAttribute("src", poster[91])
		srcPoster3.setAttribute("alt", alt[91])
		srcPoster3.setAttribute("title", title[91])
		href3.setAttribute("href", enlace[91])
		href3.textContent = textEnlace[91]
		srcPoster4.setAttribute("src", poster[92])
		srcPoster4.setAttribute("alt", alt[92])
		srcPoster4.setAttribute("title", title[92])
		href4.setAttribute("href", enlace[92])
		href4.textContent = textEnlace[92]
		srcPoster5.setAttribute("src", poster[93])
		srcPoster5.setAttribute("alt", alt[93])
		srcPoster5.setAttribute("title", title[93])
		href5.setAttribute("href", enlace[93])
		href5.textContent = textEnlace[93]
		srcPoster6.setAttribute("src", poster[94])
		srcPoster6.setAttribute("alt", alt[94])
		srcPoster6.setAttribute("title", title[94])
		href6.setAttribute("href", enlace[94])
		href6.textContent = textEnlace[94]
		srcPoster7.setAttribute("src", poster[95])
		srcPoster7.setAttribute("alt", alt[95])
		srcPoster7.setAttribute("title", title[95])
		href7.setAttribute("href", enlace[95])
		href7.textContent = textEnlace[95]
		srcPoster8.setAttribute("src", poster[96])
		srcPoster8.setAttribute("alt", alt[96])
		srcPoster8.setAttribute("title", title[96])
		href8.setAttribute("href", enlace[96])
		href8.textContent = textEnlace[96]
		...
		srcPoster10.setAttribute("src", poster[98])
		srcPoster10.setAttribute("alt", alt[98])
		srcPoster10.setAttribute("title", title[98])
		href10.setAttribute("href", enlace[98])
		href10.textContent = textEnlace[98]
		srcPoster11.setAttribute("src", poster[99])
		srcPoster11.setAttribute("alt", alt[99])
		srcPoster11.setAttribute("title", title[99])
		href11.setAttribute("href", enlace[99])
		href11.textContent = textEnlace[99]
		srcPoster12.setAttribute("src", poster[53])
		srcPoster12.setAttribute("alt", alt[53])
		srcPoster12.setAttribute("title", title[53])
		href12.setAttribute("href", enlace[53])
		href12.textContent = textEnlace[53]
		srcPoster13.setAttribute("src", poster[29])
		srcPoster13.setAttribute("alt", alt[29])
		srcPoster13.setAttribute("title", title[29])
		href13.setAttribute("href", enlace[29])
		href13.textContent = textEnlace[29]
		...
		srcPoster15.setAttribute("src", poster[40])
		srcPoster15.setAttribute("alt", alt[40])
		srcPoster15.setAttribute("title", title[40])
		href15.setAttribute("href", enlace[40])
		href15.textContent = textEnlace[40]
}
