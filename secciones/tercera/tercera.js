...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/sono bisque 11.jpg"
	contenedorImg.appendChild(imagen1)
	tituloItem.innerHTML = "Sono Bisque Doll Wa Koi Wo Suru"
	titulo.appendChild(tituloItem)
	informacionItem.innerHTML = "<b>Wakana Gojo</b> es un joven aspirante a heredar el trabajo de su familia, el diseño y la confeccion de muñecas para Hinamatsuri, las cuales ademas con su aficcion y pasion, por lo que no ha tenido tiempo de tener amistades o alguna otra relacion social."
...
function avanzar(){
	...
	if (adelanteA == true) {
		...
		pieDelTituloContainer.appendChild(pieDelTitulo1)
		pieDelTitulo2.innerHTML = "24 Ep 2023"
		pieDelTituloContainer.appendChild(pieDelTitulo2)
		pieDelTitulo3.innerHTML = "720p"
		pieDelTituloContainer.appendChild(pieDelTitulo3)
		...
		imagen1.src = "../../imagenes/Blue-Lock.jpg"
		contenedorImg.appendChild(imagen1)
		...
		tituloItem.innerHTML = "Blue Lock"
		titulo.appendChild(tituloItem)
		informacionItem.innerHTML = `Centrada en el genero deportivo, concretamente Futbol, la serie se ambienta tras los resultados de la seleccion de japon despues el mundial 2018.`
		informacion.appendChild(informacionItem)
		pieDelTitulo1.innerHTML = "9/10"
		pieDelTituloContainer.appendChild(pieDelTitulo1)
		pieDelTitulo2.innerHTML = "24 cap 2022"
		pieDelTituloContainer.appendChild(pieDelTitulo2)
		pieDelTitulo3.innerHTML = "720p"
		pieDelTituloContainer.appendChild(pieDelTitulo3)
		...
		imagen2.src = "../../imagenes/oshi no ko img 4.jpeg"
		contenedorImg.appendChild(imagen2)
		...
		tituloItem.innerHTML = "Oshi No Ko"
		titulo.appendChild(tituloItem)
		informacionItem.innerHTML = "<b>Goro</b> es un medico que lleva el parto de su idol favorita, <b>Ai Hoshino</b>, que ha tomado un paron en su carrera de <b>Idol</b> para tener a sus gemelas. Antes de que Ai de a luz, Goro muere en un accdente, y es reencarnado en una de las gemelas de Ai, <b>Aquamarine Hoshino</b>, pero con sus recuerdos intactos"
		informacion.appendChild(informacionItem)
		pieDelTitulo1.innerHTML = "9/10"
		pieDelTituloContainer.appendChild(pieDelTitulo1)
		pieDelTitulo2.innerHTML = "11 cap 2023"
		pieDelTituloContainer.appendChild(pieDelTitulo2)
		pieDelTitulo3.innerHTML = "720p"
		pieDelTituloContainer.appendChild(pieDelTitulo3)
...
function ultimos(){
		...
		srcPoster2.setAttribute("src", poster[72])
		srcPoster2.setAttribute("alt", alt[72])
		srcPoster2.setAttribute("title", title[72])
		href2.setAttribute("href", enlace[72])
		href2.textContent = textEnlace[72]
		...
		srcPoster5.setAttribute("src", poster[73])
		srcPoster5.setAttribute("alt", alt[73])
		srcPoster5.setAttribute("title", title[73])
		href5.setAttribute("href", enlace[73])
		href5.textContent = textEnlace[73]
